...
//
//
var _default = { data: function data() {return { title: 'Hello', isShow: false, topItem: '' };}, onLoad: function onLoad() {console.log('home page on load');_testBus.default.$on('sendData', function (data) {console.log(data);});}, methods: { handleScroll: function handleScroll(ev) {//console.log(ev);
      var scrollTop = ev.detail.scrollTop;this.isShow = scrollTop > 500;this.topItem = '';}, handleBanner: function handleBanner(link) {// console.log(1111);
      uni.navigateTo({ url: "./banner-ad?link=".concat(link) });} } };exports.default = _default;
