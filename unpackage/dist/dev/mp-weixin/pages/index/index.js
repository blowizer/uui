...
//
//
var _default = { data: function data() {return { title: 'Hello' };}, onLoad: function onLoad() {console.log('home page on load');_testBus.default.$on('sendData', function (data) {console.log(data);});}, methods: { handleBanner: function handleBanner(link) {// console.log(1111);
