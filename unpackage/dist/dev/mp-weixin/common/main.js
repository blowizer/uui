...
wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;_vue.default.use(_uviewUi.default);var myComp = function myComp() {__webpack_require__.e(/*! require.ensure | components/test-my-comp */ "components/test-my-comp").then((function () {return resolve(__webpack_require__(/*! components/test-my-comp.vue */ 190));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};

_vue.default.component('test-my-comp', myComp);var NavCustom = function NavCustom() {__webpack_require__.e(/*! require.ensure | components/nav-custom */ "components/nav-custom").then((function () {return resolve(__webpack_require__(/*! components/nav-custom.vue */ 195));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};

_vue.default.component('nav-custom', NavCustom);var HomeTitle = function HomeTitle() {__webpack_require__.e(/*! require.ensure | components/home-title */ "components/home-title").then((function () {return resolve(__webpack_require__(/*! components/home-title.vue */ 200));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};

_vue.default.component('home-title', HomeTitle);var GoodItem = function GoodItem() {__webpack_require__.e(/*! require.ensure | components/good-item */ "components/good-item").then((function () {return resolve(__webpack_require__(/*! components/good-item.vue */ 207));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};

_vue.default.component('good-item', GoodItem);
